...
# used to popualte the Observatory States listing on the Observatories web app's 
# index.html page.
...
# python3 scrape.py states /wiki/Category:Astronomical_observatories_in_the_United_States
